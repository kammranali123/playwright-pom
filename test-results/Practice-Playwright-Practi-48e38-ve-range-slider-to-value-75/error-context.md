...
- Name: Practice.spec.ts >> Playwright Practice Page — 20 Actions >> 17 - Move range slider to value 75
- Location: tests/Practice.spec.ts:123:7
          ...
          - generic [ref=e50]:
            ...
            - generic [ref=e233]:
              ...
              - generic [ref=e235]:
                - table [ref=e236]:
                  - rowgroup [ref=e237]:
                    - row "Name Memory (MB) CPU (%) Disk (MB/s) Network (Mbps)" [ref=e238]:
                      - columnheader "Name" [ref=e239]
                      - columnheader "Memory (MB)" [ref=e240]
                      - columnheader "CPU (%)" [ref=e241]
                      - columnheader "Disk (MB/s)" [ref=e242]
                      - columnheader "Network (Mbps)" [ref=e243]
                  - rowgroup [ref=e244]:
                    - row "Internet Explorer 66.3 MB 8.9% 0.20 MB/s 1.2 Mbps" [ref=e245]:
                      - cell "Internet Explorer" [ref=e246]
                      - cell "66.3 MB" [ref=e247]
                      - cell "8.9%" [ref=e248]
                      - cell "0.20 MB/s" [ref=e249]
                      - cell "1.2 Mbps" [ref=e250]
                    - row "Firefox 49.4 MB 2.8% 0.69 MB/s 6.8 Mbps" [ref=e251]:
                      - cell "Firefox" [ref=e252]
                      - cell "49.4 MB" [ref=e253]
                      - cell "2.8%" [ref=e254]
                      - cell "0.69 MB/s" [ref=e255]
                      - cell "6.8 Mbps" [ref=e256]
                    - row "Chrome 31.3 MB 1.0% 0.80 MB/s 4.5 Mbps" [ref=e257]:
                      - cell "Chrome" [ref=e258]
                      - cell "31.3 MB" [ref=e259]
                      - cell "1.0%" [ref=e260]
                      - cell "0.80 MB/s" [ref=e261]
                      - cell "4.5 Mbps" [ref=e262]
                    - row "System 48.3 MB 1.6% 0.36 MB/s 5.7 Mbps" [ref=e263]:
                      - cell "System" [ref=e264]
                      - cell "48.3 MB" [ref=e265]
                      - cell "1.6%" [ref=e266]
                      - cell "0.36 MB/s" [ref=e267]
                      - cell "5.7 Mbps" [ref=e268]
                - generic [ref=e269]:
                  - paragraph [ref=e270]:
                  ...
                  - paragraph [ref=e272]:
                    ...
                    - strong [ref=e273]: 49.4 MB
                  - paragraph [ref=e274]:
                    - text: "Network speed of Chrome process:"
                    - strong [ref=e275]: 4.5 Mbps
                  - paragraph [ref=e276]:
                    - text: "Disk space of Firefox process:"
                    - strong [ref=e277]: 0.69 MB/s
            - generic [ref=e278]:
...
```ts
  66  |   // Wait for URL to match a pattern — use after form submit or link click
  67  |   async waitForUrl(urlPattern: string | RegExp, timeout = 30000): Promise<void> {
  68  |     await this.page.waitForURL(urlPattern, { timeout });
  69  |   }
  70  | 
  71  |   // ── Click ───────────────────────────────────────────────────────────────────
  72  | 
  73  |   // Standard click — Playwright auto-waits for visibility, stability, enabled
  74  |   async click(locator: Locator): Promise<void> {
  75  |     await locator.click();
  76  |   }
  77  | 
  78  |   // Double click
  79  |   async doubleClick(locator: Locator): Promise<void> {
  80  |     await locator.dblclick();
  81  |   }
  82  | 
  83  |   // Right click
  84  |   async rightClick(locator: Locator): Promise<void> {
  85  |     await locator.click({ button: 'right' });
  86  |   }
  87  | 
  88  |   // Scroll into view then click — only needed for elements outside the viewport
  89  |   async scrollAndClick(locator: Locator): Promise<void> {
  90  |     await locator.scrollIntoViewIfNeeded();
  91  |     await locator.click();
  92  |   }
  93  | 
  94  |   // Force click — bypasses actionability checks, use sparingly
  95  |   async forceClick(locator: Locator): Promise<void> {
  96  |     await locator.click({ force: true });
  97  |   }
  98  | 
  99  |   // ── Input ───────────────────────────────────────────────────────────────────
  100 | 
  101 |   // Clear field and fill with value — Playwright auto-waits for the element
  102 |   async fill(locator: Locator, value: string): Promise<void> {
  103 |     await locator.clear();
  104 |     await locator.fill(value);
  105 |   }
  106 | 
  107 |   // Type character by character — use for autocomplete or debounced inputs
  108 |   async typeSlowly(locator: Locator, value: string, delay = 50): Promise<void> {
  109 |     await locator.clear();
  110 |     await locator.pressSequentially(value, { delay });
  111 |   }
  112 | 
  113 |   // Clear an input field
  114 |   async clear(locator: Locator): Promise<void> {
  115 |     await locator.clear();
  116 |   }
  117 | 
  118 |   // Press a keyboard key globally e.g. 'Enter', 'Tab', 'Escape'
  119 |   async pressKey(key: string): Promise<void> {
  120 |     await this.page.keyboard.press(key);
  121 |   }
  122 | 
  123 |   // Press a key on a specific element
  124 |   async pressKeyOnElement(locator: Locator, key: string): Promise<void> {
