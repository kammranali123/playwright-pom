...
- Name: login.spec.ts >> Login >> valid login redirects away from login page
...
Error: locator.fill: Error: strict mode violation: getByLabel('Password') resolved to 2 elements:
    1) <input size="1" value="" id="password" name="password" type="password" class="v-field__input" autocomplete="current-password" aria-labelledby="password-label" aria-describedby="password-messages"/> aka getByRole('textbox', { name: 'Password' })
            ...
            - generic [ref=e47]:
              - generic [ref=e49]:
                ...
                - generic [ref=e54]:
                  ...
                  - textbox "Email or Username" [active] [ref=e55]: changeme@example.com
              - alert [ref=e56]
            - generic [ref=e58]:
              - generic [ref=e60]:
                - img [ref=e63]
